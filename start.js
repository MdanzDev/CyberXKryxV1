...
return {
conversation: 'WhatsApp Bot By Kryx'
}}})
...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*#- KRYX VERSION 3.0.0*

Don't forget to follow to the Channel developer -> https://chat.whatsapp.com/Do9CkQszkIlDIbSHKXzFGl so you can get the latest updates about this script :)`.toString()}`})
console.log(chalk.blue.bold(`Kryx Connected ✓\n\n`))
randomToken(Sky)
...
profile = 'https://files.catbox.moe/upk5my.png';
}
if (action == 'add') {
